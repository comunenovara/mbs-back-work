...
-- AddForeignKey
ALTER TABLE `nomina` ADD CONSTRAINT `nomina_incaricoId_fkey` FOREIGN KEY (`incaricoId`) REFERENCES `incarico`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `nomina` ADD CONSTRAINT `nomina_tecnicoId_fkey` FOREIGN KEY (`tecnicoId`) REFERENCES `tecnico`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
